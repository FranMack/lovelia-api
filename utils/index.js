...
const {kingMayaInfo}=require("./kinMaya.info")
const {chineseHoroscopeInfo}=require("./chineseHoroscope.info")
const {tonesInfo}=require("./tones.info")
const{sunInfo}=require("./sun.info");
const {moonInfo}=require("./moonInfo")
const {sunHouseInfo}=require("./sunHouse.info");
