...
const numberInfo={
    ...
    1:{
        ...
        text:[
            ...
            "El aprendizaje de quienes llevan este número de destino radica en construir una identidad sólida y liberarse de la necesidad de aprobación externa. Deben cultivar su autoestima y autenticidad, enfrentándose al miedo de mostrarse como son y desafiando normas, lo que requiere tomar riesgos.",
            "En su fase de sombra, los número 1 pueden ser dominantes y autoritarios, priorizando su autosatisfacción sobre el bienestar de los demás. Pueden tener dificultades para trabajar en equipo y tienden a abandonar proyectos, siendo a veces obstinados, impulsivos y egocéntricos. Además, temen que cuestionen su imagen."
          ]
    },
    2:{
        ...
        text:[
            ...
            "Quienes tienen el 2 como número de destino vienen a aprender el equilibrio entre dar y recibir y a desarrollar la capacidad de ver desde la perspectiva de los otros, fomentando la paciencia, la tolerancia y el trabajo en equipo. La energía maternal de este número enfatiza la compasión y la nutrición, haciendo que las experiencias con la figura materna sean cruciales en su desarrollo.",
            "En sombra, las personas influenciadas por el 2 pueden ser egocéntricas, tener dificultades en la comunicación y ser emocionalmente dependientes. Deben cuidarse de no delegar sus responsabilidades y evitar buscar la comodidad en lugar de la autonomía o caer en comportamientos manipuladores y celosos. En esta fase también pueden tener una tendencia a evadir conflictos, lo que las lleva a perder su identidad al tratar de complacer a los demás."
          ]
    },
    3:{
        ...
        text:[
            ...
            "En su aspecto de sombra, tienen una tendencia a la ilusión y a la irresponsabilidad. A veces su impulsividad y naturalidad puede llevarlos a imprudencias y dispersiones. En esta fase pueden caer en excesos, mentiras y egocentrismo."
          ]
    },
    4:{
        ...
        text:[
            ...
            "Las personas que tienen el número 4 de destino vienen a aprender lecciones vinculadas al cuerpo físico y al mundo material. Su reto es descubrir los misterios de la materia y cómo convertir sus ideas en realidad. Necesitarán cultivar un enfoque práctico, establecer metas claras y mantener la constancia para alcanzarlas, mientras aprenden a equilibrar la estabilidad con la flexibilidad ante el cambio. La lección central es desarrollar paciencia, madurez y la habilidad para enfrentar obstáculos sin desviarse de sus objetivos.",
            "En su estado de sombra, estas personas deben tener cuidado con sus aspectos rígidos, obstinados y su falta de conexión emocional, que puede llevarlas a sentirse inseguras. Tiene un comportamiento defensivo y una resistencia al cambio que pueden provocar problemas relacionados con el estrés."
          ]
    },
    5:{
        ...
        text:[
            ...
            "Las personas quienes tiene el 5 como número de destino, vienen a aprender sobre su independencia y la necesidad de explorar lo desconocido, volviéndose flexibles ante obstáculos y desapegándose de lo aprendido. Deben atreverse a experimentar y adaptarse a nuevas ideas.",
            "En su fase de sombra, estas personas albergan interiormente un gran temor al fracaso y pueden mostrarse orgullosos y superficiales. También pueden tener dificultades con la intimidad y la estabilidad emocional, además pueden llegar a ser intolerantes con quienes resisten el cambio."
          ]
    },
    6:{
        ...
        text:[
            ...
            "Quienes tienen el 6 como número de destino, vienen a aprender a transitar un camino de servicio a través del amor y la familia. También a ofrecer apoyo material y emocional a sus seres queridos y a buscar la armonía en las relaciones. Valorará el trabajo en equipo y la justicia, aunque también enfrentarán desafíos como la idealización de sus parejas, lo que puede obstaculizar relaciones reales y satisfactorias. También tendrá que aprender a desarrollar habilidades en comunicación y a considerar las necesidades ajenas.",
            "En su fase de sombra, quienes llevan este número pueden manifestarse superficiales, buscando lo estético por encima de lo sustancial. Esto puede derivar en comportamientos hipócritas y complacientes que fomenten relaciones vacías y conflictos familiares. En esta etapa, las personas pueden volverse celosas, egoístas, indecisas y discutir sobre temas triviales, lo que les impedirá alcanzar la armonía en sus vidas."
          ]
    },
    7:{
        ...
        text:[
            ...
            "Quienes tiene el 7 como número de destino, vienen a aprender a equilibrar la existencia material con la comprensión espiritual. Aquellos con esta lección de vida deben aprender a lograr metas en el mundo práctico, mientras mantienen su conexión con su esencia espiritual. Deben desarrollar la disciplina, la excelencia y la profundidad de carácter. La meditación y el estudio son herramientas esenciales que les ayudarán a recordar y aplicar la sabiduría de sus experiencias pasadas.",
            "Sin embargo, en su fase de sombra, estas personas pueden manifestar confusión, egocentrismo y dificultad para integrarse con los demás. También ser melancólicas, extremadamente perfeccionistas o soberbias. La tendencia a intelectualizar sus emociones puede llevarlas a desconectarse de su espiritualidad. Para evitar estos comportamientos es crucial que trabajen en la humildad, la sensibilidad y la apertura mental hacia diferentes perspectivas y experiencias."
          ]
    },
    8:{
        ...
        text: [
            ...
            "Quienes tiene el 8 como numero de destino, vienen a aprender a involucrar la capacidad de transformar ideas en realidad, utilizando sus visiones para establecer una conexión entre el plano espiritual y el mundo físico. Este proceso también implica la necesidad de ejercer autoridad y poder con integridad, lo que incluye desarrollar autodisciplina, perseverancia y paciencia. Enfrentar desafíos, la culpa y superar sus propios límites es parte del camino hacia el desarrollo personal.",
            "En la etapa de sombra, el número 8 puede manifestar ciertos rasgos de autoritarismo, rigidez y perfeccionismo extremo. Estas personas tienden a ser críticas, tanto con ellas mismas como con los demás, y pueden caer en comportamientos inescrupulosos con el fin de obtener poder y riqueza."
          ]
    },
    9:{
        ...
        text:[
            ...
            "Quienes tienen el 9 como numero de destino, vienen a aprender a desarrollar una perspectiva trascendental y buscar la verdad espiritual, explorando diversas corrientes filosóficas y religiosas. También en tomar conciencia de que tienen la responsabilidad de liderar y enseñar a otros en su búsqueda de la verdad y de fomentar una conexión basada en el amor universal. Este camino puede incluir pruebas significativas que desafíen su servicio desinteresado y que requieran superar el egoísmo, promoviendo así una mayor empatía y compasión.",
            "En su estado de sombra estas personas pueden manifestar impaciencia, egocentrismo e intolerancia y tener dificultades para comprometerse, volviéndose solitarias o agresivas cuando se sienten amenazadas. Esta fase incluye la ingratitud y la confusión respecto a su misión de vida, llevándolos a una lucha interna."
          ]
    },
}
