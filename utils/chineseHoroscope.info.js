const chineseHoroscopeInfo = {
  Rat: {
    commonInfo: {
      title: "Rat",
      text: [
        "La Rata simboliza tanto la astucia y la inteligencia como la conexión con lo oculto y misterioso en la vida. Este animal se revela como un ser que ha logrado entender y adaptarse a su medio, mostrando una evolución que la convierte en un símbolo de sabiduría y reflexión a medida que avanza en su ciclo de vida.",
        "Las personas nacidas bajo este signo poseen una naturaleza intensa y algo inconstante en el amor. Su capacidad para experimentar pasiones es una de sus características más destacadas, aunque estas emociones tienden a ser efímeras. La Rata busca la variedad y la aventura, y se siente poco a gusto en roles laborales monótonos o rutinarios. Cuando se encuentra en un ambiente desafiante y emocionante, exhibe su ingenio y su capacidad para adaptarse. Intentan vivir siempre sus experiencias y conocer nuevas sensaciones.",
      ],
    },
    Metal: {
      title: "Rata de Metal ",
      text: [
        "La Rata influenciada por el Metal tiende a la soledad y, en ocasiones, puede ser vista por los demás como triste o rara. Son personas que a veces pueden sentirse socialmente presionadas por el entorno y otras a gusto entre los suyos, siempre que los demás permitan sus críticas y sus juicios inflexibles. ",
      ],
    },
    Earth: {
      title: "Rata de Tierra",
      text: [
        "La Rata bajo el elemento Tierra suele sentir seguridad y tranquilidad en lo económico. A veces se les percibe como egoístas y avaros, aunque esta percepción puede ser engañosa. Estas personas tienden a encontrar un equilibrio entre la reflexión y la acción.",
      ],
    },
    Fire: {
      title: "Rata de Fuego",
    ...
    Wood: {
      title: "Rata de Madera",
      text: [
        "El elemento Madera le otorga a la Rata equilibrio con su entorno. Son personas diplomáticas, comprensivas y apacibles. La Madera les confiere armonía y calma, belleza y apresto.",
      ],
    },
  },
  Ox: {
    commonInfo: { title: "Búfalo", text: [
        "El Búfalo simboliza la perseverancia y el enfoque en los propósitos. Los nativos bajo este signo se destacan por su determinación y su capacidad para seguir adelante sin distraerse ni preocuparse por las críticas. La sencillez también es una cualidad fundamental del Búfalo, que prioriza la búsqueda de lo esencial.",
        "Tienen un encanto especial, mezclan buenas maneras, belleza y serenidad. Separan el amor de la sensualidad, de la cual disfrutan sin culpa. Su naturaleza es fuerte y resistente y cuidan de su salud.",
        "Son seres de paciencia y fortaleza, de trabajo y perseverancia, de constancia profesional. No les atrae moverse sin una meta y evitan riesgos o sorpresas."
      ] },
  ...
  Tiger: {
    commonInfo: { title: "Tigre", text: [
        "El tigre representa tanto la fuerza como la sabiduría ancestral y simboliza la protección, así como la defensa. Es considerado un poderoso protector que salvaguarda a los más vulnerables, al tiempo que su fuerza, energía y vitalidad lo posicionan como un líder que evoca respeto y temor.",
        "Los nacidos bajo este signo necesitan de la compañía de sus amigos y de quienes los aman, pero no lo saben o no quieren aceptar la necesidad de amar y ser amados al mismo tiempo. La soledad no le afecta y los desengaños tampoco, ya que se acostumbran a ser reyes de lo terreno. Para un Tigre es más importante la ambición que el objeto ambicionado y cree que el éxito viene dado por la disciplina.",
        "El Tigre se deslumbra por su propio resplandor y no perderá la oportunidad de encontrarse en situaciones en las que pueda ser admirado. Es amante del riesgo y de los desafíos, especialmente si puede compartir esos momentos con sus seres queridos."
      ] },
  ...
  Rabbit: {
    commonInfo: { title: "Gato", text: [
        "El Gato simboliza la dualidad entre la búsqueda de un equilibrio interno y las exigencias del mundo exterior. Estas personas tienden a refugiarse en la soledad, el silencio y la reflexión, lo que las hace discretas y prudentes. Se enfrentan a la dificultad de actuar de acuerdo con sus deseos sin que ello sea visto como egoísmo, y son leales y afectuosas con quienes han construido una relación de confianza, ofreciendo amistad sincera y un fuerte compromiso en el amor.",
        "El Gato se caracteriza por ser trabajador y generoso, con una clara comprensión sobre la prudencia en contraste con el exceso. No busca acumular innecesariamente, ya que prefiere disfrutar de la seguridad que le ofrece su refugio, compartiendo lo que tiene con los demás. Valora lo esencial, sin dejarse distraer por lo superfluo, al mismo tiempo que evita cualquier situación que lo aleje de su zona de confort.",
        "Quienes nacieron bajo este signo rechazan posturas rígidas que no permiten matices, optando por adaptarse a distintas circunstancias sin tener que elegir un único camino. Al mismo tiempo, se mantienen alejados de lo desconocido, ya que necesitan tener control sobre las situaciones y un grado de previsión que les brinde tranquilidad."
      ] },
  ...
  Dragon: {
    commonInfo: { title: "Dragón", text: [
        "El Dragón es una figura fascinante y poderosa, venerada y temida a lo largo de la historia. Simboliza los desafíos y obstáculos que se presentan en la vida y la perseverancia para superarlos con valentía y determinación.",
        "Los nativos bajo este signo son apasionados y ven sus sentimientos como incuestionables. Intensos en el amor, no admiten dudas y esperan correspondencia. La necesidad de admiración y apoyo es vital para su bienestar.",
        "Son enérgicos y activos en lo laboral y poseen una fuerte capacidad de liderazgo. Prefieren evitar la rutina y buscan constantemente desafíos que los impulsen a superar los límites. Aceptan la responsabilidad de sus decisiones y son conscientes de que su éxito depende de su propio esfuerzo. Los desafíos son esenciales para sus vidas y los motivan a buscar constantemente nuevas experiencias."
      ]},
  ...
  Snake: {
    commonInfo: { title: "Serpiente", text: [
        "La Serpiente simboliza tanto la energía mental como la vitalidad física. Esta dualidad ejemplifica una fusión de opuestos que genera armonía.",
        "Los nacidos bajo el signo son frecuentemente personas con un encanto natural y una capacidad innata de seducción. Su presencia es cautivadora y su habilidad para encantar es muy poderosa.",
        "Son cuidadosos a la hora de mantener el equilibrio necesario en sus vidas y poseen una intuición aguda y mucha paciencia, con las que son capaces de alcanzar sus metas.",
        "Las personas que poseen este signo suelen ser cautelosas y reflexivas y analizan detenidamente las variables antes de embarcarse en nuevas experiencias."
      ] },
  ...
  Horse: {
    commonInfo: { title: "Caballo", text: [
        "El Caballo representa fuerza y vitalidad y simboliza también la lucha entre el instinto y la conciencia.",
        "Estos seres tienen una intensa y volátil capacidad de amar. Se enamoran profundamente a partir de pequeños gestos o palabras y experimentan una pasión que afecta todo su ser. Sin embargo, una vez pasada la vorágine del momento, quedan con una sensación de agotamiento y una percepción de haber amado algo que no tenía una base real.",
        "Son propensos a somatizar excesivamente sus emociones y ansiedades, por lo que el autocuidado es crucial para evitar el desgaste físico y emocional.",
        "Los Caballos prefieren trabajar de manera independiente y evitan la rutina y la burocracia. Son fuertes y eficientes y su libertad y autonomía son fundamentales para su satisfacción en el campo laboral. En ocasiones necesitan evadirse de la vida cotidiana y buscar experiencias que les permitan escapar de la rutina."
      ] },
  ...
  Goat: {
    commonInfo: { title: "Cabra", text: [
        "La Cabra es símbolo de protección y maternidad. Son personas que se destacan por su sinceridad y lealtad, genuinas y que no se preocupan por las apariencias o normas sociales. Su amor es transparente, no buscan manipular y son fieles siempre que se sientan correspondidas.",
        "Los nacidos bajo el signo Cabra suelen ser poco posesivos y no tienden a quejarse de sus dolencias, lo que a veces puede hacer que sus problemas de salud pasen desapercibidos.",
        "Generalmente son metódicos y alcanzan sus objetivos con dedicación y tiempo, aunque su trabajo suele ser discreto y no buscan destacarse. Prefieren cumplir con sus responsabilidades sin ambición de liderar o de hacerse notar.",
        "Si bien estas personas buscan retos físicos o aventuras extremas, están abiertas a explorar nuevas formas de vida y de pensamiento. El descubrimiento está para ellas más en la introspección que en la exploración física del mundo."
      ] },
  ...
  Monkey: {
    commonInfo: { title: "Mono", text: [
        "El Mono representa la evolución desde lo primitivo hacia lo espiritual. Simboliza el crecimiento y la capacidad de adaptación.",
        "Las personas nacidas bajo este signo son reconocidas por su carácter encantador y divertido. Son inteligentes y tienen la habilidad de entretener a otros. Esta combinación entre el atractivo y las habilidades sociales hace que sean muy deseados como parejas y agradables en su círculo social.",
        "El Mono se destaca por su curiosidad innata, motor de avance en la ciencia y del conocimiento. A pesar de este rasgo, no es necesariamente aventurero. En ocasiones, se siente atrapado por la rutina y busca escapar mediante pequeños actos de rebeldía o aventuras impulsivas.",
  ...
  Rooster: {
    commonInfo: { title: "Gallo", text: [
        "El Gallo simboliza tres aspectos: lo aparente, lo evidente y lo sensible, lo que lo convierte en un signo complejo, difícil de comprender en su totalidad. Las personas nacidas bajo esta posición son percibidas como poseedoras de un magnetismo especial, que las distingue de las de otros signos. Son seres que ven más allá de lo superficial y suelen centrarse en las causas fundamentales.",
        "El Gallo es también el símbolo de quien anuncia el nuevo día, por lo que se lo asocia con la vigilancia y la actividad constante.",
        "Las personas nacidas bajo este signo se caracterizan por ser divertidas, apasionadas y dulces. Suele ser buenas compañeras, optimistas y abordan la vida con despreocupación, priorizando su libertad y su trabajo, que asumen con mucha responsabilidad.",
        "El Gallo está siempre abierto a nuevas experiencias, ya que le atrae el cambio y la novedad. No obstante, no actúa de manera impulsiva; prefiere reflexionar y contemplar las consecuencias antes de tomar decisiones drásticas."
      ] },
  ...
  Dog: {
    commonInfo: { title: "Perro", text: [
        "El perro simboliza la fidelidad y lealtad, características que reflejan su rol como protector y guía del hombre a lo largo de la historia. Asociado a diversas figuras mitológicas y creencias, el perro ha sido visto como un guardián que acompaña a los seres humanos en su camino.",
        "Los nativos de este signo son leales y fieles y en esto se asientan sus relaciones. Son algo melancólicos, porque el pesimismo y la angustia tienen una parte importante en sus vidas y presiden muchas de sus reacciones.",
        "El Perro es aprensivo y cree que el mal se va a apoderar de él sin remisión, como si estuviera predispuesto para lo peor.",
        "Es especialmente trabajador y se desvive por hacer la tarea pactada de antemano. Es un poco serio y cumple a la perfección con su deber, pero suele tener una sombra permanente de pesimismo y una angustia contenida que nubla sus logros.",
        "Este signo es reacio a los cambios y a lo desconocido, prefiere un entorno predecible y seguro que resguarde su tranquilidad. La aventura le gusta, pero vista desde fuera. Es como si tuviera marcado el camino y bien señalados los linderos de su actuación en la Tierra."
      ] },
  ...
  Pig: {
    commonInfo: { title: "Jabalí", text: [
        "El Jabalí simboliza por un lado el arrojo y el valor, y por el otro, el desenfreno y la desmesura.",
        "Suelen ser personas sencillas y honestas, que valoran la tranquilidad y evitan las complicaciones en la vida cotidiana y en el ámbito afectivo.",
        "El Jabalí es esforzado en su trabajo, ordenado y cumple con lo pactado. No deja que la ambición ni el afán de triunfo guíe su vida. A la hora de elegir, prueba las variables y luego piensa, ya que le atrae la experiencia, a través de la cual va conociendo sus propios límites.",
        "Son seres con una gran capacidad de adaptación y de disfrute sin límites."
      ] },
...
module.exports={chineseHoroscopeInfo}